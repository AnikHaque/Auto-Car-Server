...
async function run() {
    try {
      ...
      const database = client.db("auto-car");
       const carcollection = database.collection("car");
        const carbookingcollection = database.collection("carbooking");
...
app.get('/car/:id', async(req,res)=>{
  ...
  const hotel = await carcollection.findOne(query);
  res.json(hotel);
...
app.post('/car', async(req, res) => {
    ...
    const result = await carcollection.insertOne(newhotel);
...
app.post('/carbooking', async(req, res) => {
  ...
  const result = await carbookingcollection.insertOne(newroom);
  console.log('hitting the post',req.body);      
  res.json(result);
